...
"$FF" -hide_banner -loglevel error \
  ...
  -filter_complex "\
    ...
    [1:a]aresample=44100,atrim=0:${DUR},afade=t=in:st=0:d=1.6,volume=0.24,aformat=channel_layouts=stereo[mq]; \
    [mq][vc1]sidechaincompress=threshold=0.045:ratio=5:attack=25:release=440:makeup=1[mduck]; \
