...
"$FF" -hide_banner -loglevel error \
  ...
  -filter_complex "\
    ...
    [1:a]aresample=44100,atrim=0:${DUR},afade=t=in:st=0:d=0.25,volume='0.30+0.32*exp(-t*0.9)':eval=frame,aformat=channel_layouts=stereo[mq]; \
    [mq][vc1]sidechaincompress=threshold=0.045:ratio=6:attack=20:release=420:makeup=1[mduck]; \
